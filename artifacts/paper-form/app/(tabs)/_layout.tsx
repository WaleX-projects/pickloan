  ...
  return (
    <NativeTabs>
      ...
      <NativeTabs.Trigger name="sync">
        <NativeTabs.Trigger.Icon sf={{ default: 'arrow.triangle.2.circlepath', selected: 'arrow.triangle.2.circlepath.circle.fill' }} />
...
function ClassicTabLayout() {
  ...
  return (
    ...
    >
      ...
      />
      <Tabs.Screen name="forms" options={{ title: 'Forms', tabBarIcon: ({ color }) => <Feather name="file-text" size={22} color={color} /> }} />
      <Tabs.Screen name="sync" options={{ title: 'Sync', tabBarIcon: ({ color }) => <Feather name="refresh-cw" size={22} color={color} /> }} />
